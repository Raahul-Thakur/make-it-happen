...
export default function Hero() {
  ...
  return (
    <section className="relative overflow-hidden bg-[#f8efe2] text-[#111114]">
      ...
      <div className="absolute bottom-[22%] left-[24%] h-28 w-28 rounded-[43%_57%_61%_39%/54%_35%_65%_46%] border border-black/8 bg-white/45 backdrop-blur-sm md:h-36 md:w-36" />
